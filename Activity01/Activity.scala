...
// Read CSV
val df_ses_log_csv = spark.read.options(Map("inferSchema"->"true","delimiter"->",","header"->"true")).csv("F:/Data/session_log.csv")
...
// Writing AVRO
df_ses_log_csv.write.format("avro").save("F:/Data/session_log.avro")
// Output: 454 MB


// Writing ORC
df_ses_log_csv.write.orc("F:/Data/session_log.orc")
// Output: 182 MB


// Writing PARQUET
df_ses_log_csv.write.parquet("F:/Data/session_log.parquet")
// Output: 115 MB
...
// Read the data frame
var df_ses_log_parquet = spark.read.parquet("F:/Data/session_log.parquet")
var df_ses_log_orc = spark.read.orc("F:/Data/session_log.orc")
var df_ses_log_avro = spark.read.format("avro").load("F:/Data/session_log.avro")
